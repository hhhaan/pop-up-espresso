    ...
    return (
        <div className="flex p-4 h-screen flex-col">
            <section className="flex flex-col mb-20">
                ...
                <p className="text-sm mt-1 tracking-tighter">
            ...
            <section className="flex flex-col mb-10">
                <p className="text-xl font-medium tracking-tighter mb-4">Ethiopia Sidama Bensa Murago Natural</p>
                <p className="text-sm tracking-tighter mb-4">
                    무라고는 타미루 타데세/알로 커피의 비교적 최근 개발된 구획으로, 주로 대회 출품용 커피를 생산합니다.
                    해당 lot는 74158 품종으로, 2021년 COE에서 5위를 차지한 바 있으며, 특히 이 품종은 2020년 제1회
                    에티오피아 COE에서 니구세 게메다가 1위를 수상하며 널리 알려졌습니다.
                </p>
                <div className="flex flex-col items-center mb-10">
            ...
            <section className="flex flex-col">
                <div className="flex flex-col items-center mb-10">
                    ...
                    <p className="text-xs mt-1 text-[#666] tracking-tighter text-center">
            ...
            <section className="flex flex-col">
                <div className="flex flex-col items-center mb-10">
                    <Image src="/123.png" alt="stack" width={400} height={400} className="object-contain " />
                    <p className="text-xs text-[#666] mt-1 tracking-tighter text-center">알로, 네츄럴 커피 가공소</p>
                </div>
                <div className="flex flex-col items-center mb-10">
                    <Image src="/2.png" alt="stack" width={400} height={400} className="object-contain " />
                    <p className="text-xs text-[#666] mt-1 tracking-tighter text-center">알로, 네츄럴 커피 가공 장면</p>
                </div>
            </section>
        </div>
    );
